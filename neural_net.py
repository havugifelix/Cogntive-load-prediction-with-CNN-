...
batch_size =16
train_data_dir ="/media/kashraf/Elements/Journal_2022/Datasets/topos_GAN+REAL/alpha/train_test/train"
...
def build_and_train(hype_space, save_best_weights=True, log_for_tensorboard=False):
  ...
  #####   
    ...
    WEIGHTS_DIR="/home/kashraf/Journal_work_Fall2021/modelling/real_gan_models/model_weights_april"
    if save_best_weights:
        weights_save_path = os.path.join(
            WEIGHTS_DIR, 'alpha_April_V1.h5'.format(model_uuid))
